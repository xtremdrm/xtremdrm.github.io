                                    ...
                                    <div class="mb-4">
                                        ...
                                        <div class="row g-3">
                                            ...
                                            <div class="col-md-6">
                                                ...
                                                <input type="tel" class="form-control" value="<%= usuario.getTelefono() %>" readonly>
                                            </div>
                                            <div class="col-md-6">
                                                <label class="form-label">Dirección</label>
                                                <input type="text" class="form-control" value="<%= usuario.getDomicilio() %>" readonly>
                                            </div>
                                            <div class="col-md-6">
                                                <label class="form-label">Ciudad</label>
                                                <input type="text" class="form-control" value="<%= usuario.getCiudad() %>" readonly>
                                            </div>
                                        </div>
                                    </div>

                                    <div>
                                        <!-- Botón de actualizar (solo estético ahora mismo) -->
                                        <input type="submit" class="actualizar mb-4" value="Actualizar información">
                                        <a href="LogoutServlet"><button class="mb-4 btn btn-danger">Cerrar Sesión</button></a>
                                    </div>
                                </div>
                            </div> <!-- col-lg-9 -->
                        </div> <!-- row -->
