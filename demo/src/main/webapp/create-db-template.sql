...
CREATE TABLE IF NOT EXISTS `pedidos` (
  ...
  KEY `pedidoproducto` (`codigo_producto`),
  CONSTRAINT `pedidopor` FOREIGN KEY (`persona`) REFERENCES `usuarios` (`codigo`),
  CONSTRAINT `pedidoproducto` FOREIGN KEY (`codigo_producto`) REFERENCES `productos` (`codigo`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_uca1400_ai_ci;

-- Volcando datos para la tabla daw.pedidos: ~0 rows (aproximadamente)
...
INSERT INTO `productos` (`codigo`, `nombre`, `precio`, `existencias`, `imagen`, `kilometros`, `marca`, `categoria`) VALUES
	(1, 'Mercedes S-Class', 110000.00, 1, 'resources/s-class.png', 1000, 'Mercedes', 'Luxury'),
	(2, 'BMW M4', 108000.00, 1, 'resources/m4.png', 800, 'BMW', 'Luxury'),
	(3, 'BMW X5', 90000.00, 1, 'resources/x5.png', 1100, 'BMW', 'Luxury'),
	(4, 'Audi RS6', 80000.00, 1, 'resources/rs6.avif', 1400, 'Audi', 'Luxury'),
	(5, 'Audi Q7', 85000.00, 1, 'resources/q7.avif', 3125, 'Audi', 'Mid'),
	(6, 'Mercedes GLC', 70000.00, 1, 'resources/glc.png', 2500, 'Mercedes', 'Mid'),
	(7, 'BMW Series 5', 60000.00, 1, 'resources/5-series.png', 2345, 'BMW', 'Mid'),
	(8, 'BMW Series 3', 50000.00, 1, 'resources/3-series.png', 1800, 'BMW', 'Mid'),
	(9, 'Mercedes E-Class', 75000.00, 1, 'resources/e-class.png', 1780, 'Mercedes', 'Mid'),
	(10, 'Audi Q2', 40000.00, 1, 'resources/q2.png', 1200, 'Audi', 'Basic'),
	(11, 'Mercedes A-Class', 35000.00, 1, 'resources/a-class.png', 2200, 'Mercedes', 'Basic'),
	(12, 'Audi A3', 30000.00, 1, 'resources/a3.avif', 3000, 'Audi', 'Basic');
...
ALTER TABLE pedidos
DROP FOREIGN KEY pedidoproducto,
