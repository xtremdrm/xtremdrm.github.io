...
<body>
    <% 
        ...
        List<Producto> productos = con.obtenerProductosBDMarca("Mercedes");
    %>
    <mi-cabecera></mi-cabecera>
    <h1><img src="resources/mercedes.svg" alt="Imagen Mercedes" width="100px"> </h1>
    <h3>Oferta de coches Mercedes</h3>
    <div class="container">
        <div class="catalogo">
