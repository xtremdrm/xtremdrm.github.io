                        ...
                        <div class="row g-0">
                            ...
                            <div class="col-lg-9">
                                <div class="p-4">
                                    ...
                                    <div class="mb-4">
                                        ...
                                        <div class="row g-3">
                                            ...
                                            <div class="col-md-6">
                                                ...
                                                <input type="text" class="form-control" value="Pardo Recio">
                                            </div>
                                            <div class="col-md-6">
                                                <label class="form-label">Email</label>
                                                <input type="email" class="form-control" value="sussybaka@example.com">
                                            </div>
                                            <div class="col-md-6">
                                            ...
                                            <div class="col-md-6">
                                                ...
                                                <input type="text" class="form-control" value="Calle Falsa 123">
                                            </div>
                                            <div class="col-md-6">
                                    ...
                                    <div>
                                        <input type="submit" class="actualizar mb-4" value="Actualizar información"></input>
                                        <a href="LogoutServlet"><button class="mb-4">Cerrar Sesión</button></a>
