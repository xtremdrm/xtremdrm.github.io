...
<body>
    <% AccesoBD con = AccesoBD.getInstance(); List<Producto> productos = con.obtenerProductosBDMarca("BMW"); %>
    <mi-cabecera></mi-cabecera>
    <h1> <img src="resources/bmw.svg" alt="Imagen 1" width="100px"> </h1>
    <h3>Oferta de coches BMW</h3>
    <div class="container">
        <div class="catalogo">
